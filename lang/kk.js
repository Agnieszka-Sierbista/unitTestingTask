(function (factory) {
    ...
    unitTestingTask.lang('kk', {
        _months: {
            nominative: 'қаңтар_ақпан_наурыз_сәуір_мамыр_маусым_шілде_тамыз_қыркүйек_қазан_қараша_желтоқсан'.split('_'),
            accusative: 'қаңтардың_ақпанның_наурыздың_сәуірдің_мамырдың_маусымның_шілденің_тамыздың_қыркүйектің_қазанның_қарашаның_желтоқсанның'.split('_')
        },
