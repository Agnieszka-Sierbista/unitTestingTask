...
const language = {long: "Russian", short: "ru"};

describe("[Unit Testing Task]: Russian language", () => {
    ...
    describe("Module own functions", () => {
        ...
        it("should call unitTestingTask.lang() with argument", () => {
            ...
            expect(unitTestingTask.lang(language.short)).toStrictEqual("ru");
        });
    ...
    describe("Meridiem function returns correctly 'rano', or nothing when A or a passed as format", () => {
        ...
        const testCases = [
            {hour: "0", expected: 'ночи'},
            {hour: "1", expected: 'ночи'},
            {hour: "2", expected: 'ночи'},
            {hour: "3", expected: 'ночи'},
            {hour: "4", expected: 'утра'},
            {hour: "5", expected: 'утра'},
            {hour: "6", expected: 'утра'},
            {hour: "7", expected: 'утра'},
            {hour: "8", expected: 'утра'},
            {hour: "9", expected: 'утра'},
            {hour: "10", expected: 'утра'},
            {hour: "11", expected: 'утра'},
            {hour: "12", expected: 'дня'},
            {hour: "13", expected: 'дня'},
            {hour: "14", expected: 'дня'},
            {hour: "15", expected: 'дня'},
            {hour: "16", expected: 'дня'},
            {hour: "17", expected: 'вечера'},
            {hour: "18", expected: 'вечера'},
            {hour: "19", expected: 'вечера'},
            {hour: "20", expected: 'вечера'},
            {hour: "21", expected: 'вечера'},
            {hour: "22", expected: 'вечера'},
            {hour: "23", expected: 'вечера'},
        ];
