...
const language = {long: "Turkish", short: "tr"};

describe("[Unit Testing Task]: Turkish language", () => {
    ...
    describe("Module own functions", () => {
        ...
        it("should call unitTestingTask.lang() with argument", () => {
            ...
            expect(unitTestingTask.lang(language.short)).toStrictEqual("tr");
        });
    ...
    datesToTest.forEach((currentDate) => {
        ...
        describe(`Formatting functions results when unitTestingTask("formatting", ${currentDate}) called`, () => {
            ...
            it("dd MMMM returns the full name of the month inflected", () => {
                ...
                expect(unitTestingTask("MMMM", currentDate)).toContain(fullMonthName);
            });
            ...
            it("dd MMM returns the medium-sized name of the month inflected", () => {
                ...
                const trimmed = mediumMonthNameInflected.length > 3 ? mediumMonthNameInflected.slice(0, 3) : mediumMonthNameInflected;

                expect(unitTestingTask("dd MMM", currentDate).split(' ').at(-1)).toBe(trimmed);
